...
function RouteComponent() {
  return <div className="flex flex-col gap-4 justify-center items-center">
	<Link to="/" className="flex gap-4 items-center justify-center p-4">
		...
		<nav className="flex gap-1 w-11/12 mx-auto">

			<Link to="/files" className="flex gap-1 items-center justify-center p-4 min-w-40"
			...
			<Link to="/files/tecnicos" className="flex gap-1 items-center justify-center p-4 min-w-40"
			activeProps={{ className: "bg-black rounded-lg" }}
					activeOptions={{ exact: true }}
			>
			...
			<Link to="/files/unused" className="flex gap-1 items-center justify-center p-4 min-w-40"
			activeProps={{ className: "bg-black rounded-lg" }}
					activeOptions={{ exact: true }}
			>
