...
function Resumen() {
  ...
  return <div className='w-5/6 mx-auto flex flex-col gap-10 tracking-wider my-14 relative'>
    <div className="flex flex-col gap-6">
				<span className="col-span-2 border-b border-white/50 mb-6">Resumen</span>
